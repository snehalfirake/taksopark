...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    <div id="container">
        <div class="one-half">
            ...
            <asp:DetailsView runat="server" id="detailsView1" DataSourceID="ordersDataSource">
            </asp:DetailsView>
                ...
                <ItemTemplate>
                    <table>
                        ...
                        <tr>
                            <td>Start Point</td>
                            <td>
                                <asp:Label runat="server" Text='<%# Eval("StartPoint") %>' />
                            </td>
                        </tr>
                        <tr>
                            <td>Destination</td>
                            <td>
                                <asp:Label runat="server" Text='<%# Eval("DestinationPoint") %>' />
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
        ...
        <div class="one-half last">
            ...
            <div>
                <div>
                    <asp:DropDownList runat="server" ID="dropDownList" Width="465" Height="25" AutoPostBack="true" OnSelectedIndexChanged="dropDownList_SelectedIndexChanged1">
